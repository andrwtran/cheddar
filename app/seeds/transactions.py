...
def seed_transactions():
  ...
  starbucks_six = Transaction(trans_date=date(2022, 3, 14), trans_payee='Starbucks', trans_amount=8.39, categoryId=6, accountId=3)
  philz_seven = Transaction(trans_date=date(2022, 3, 22), trans_payee='Philz Coffee', trans_amount=10.70, categoryId=6, accountId=2)
  aviary = Transaction(trans_date=date(2022, 3, 25), trans_payee='The Aviary', trans_amount=37.44, categoryId=6, accountId=4)
  ...
  inNOut_two = Transaction(trans_date=date(2022, 3, 17), trans_payee='In-N-Out', trans_amount=14.23, categoryId=6, accountId=2)
  chipotle_seven = Transaction(trans_date=date(2022, 3, 20), trans_payee='Chipotle', trans_amount=11.11, categoryId=6, accountId=4)
  noodles = Transaction(trans_date=date(2022, 3, 28), trans_payee='Noodles & Company', trans_amount=13.68, categoryId=6, accountId=2)
  ...
  trader_joes_three = Transaction(trans_date=date(2022, 3, 23), trans_payee='Trader Joes', trans_amount=41.93, categoryId=13, accountId=3)
  ...
  amazon_six = Transaction(trans_date=date(2022, 3, 19), trans_payee='Amazon.com', trans_amount=43.71, categoryId=19, accountId=2)
  uniqlo_three = Transaction(trans_date=date(2022, 3, 27), trans_payee='Uniqlo', trans_amount=37.25, categoryId=19, accountId=3)
  ...
  boll = Transaction(trans_date=date(2022, 3, 28), trans_payee='Boll & Branch', trans_amount=82.87, categoryId=15, accountId=2)
