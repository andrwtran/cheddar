      ...
      {editId === account?.id
        ...
        <form className='AccountEditForm' onSubmit={handleSubmit}>
          ...
          <span id="AccountEditButtons">
            {name ?
              <button className='submit-button-active' type="submit"><i class="fa-solid fa-floppy-disk" /></button> :
              <button className='submit-button-disabled' type="submit" disabled="disabled"><i class="fa-solid fa-floppy-disk" /></button>
            }
            <button className='cancel-button' type="reset" onClick={reset}><i class="fa-solid fa-square-xmark" /></button>
          </span>
        </form>
        :
        <button className="AccountEditButton" onClick={toggleEdit}><i class="fa-solid fa-pen-to-square" /></button>
      }
  </div>
  );
}
